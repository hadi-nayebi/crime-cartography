...
- [ ] **RENDER v3.1 IN PROGRESS** (bg b4naohhms) → grand-rapids-v2.mp4. Then commit+push. Stills verified: neighborhood leaderboard✓ quiz(Heritage Hill/Midtown/West Grand)✓ reveal(Heritage Hill 210 safest, West Grand busiest)✓ per-month line+658 ref✓ transition bridge✓ neutral close✓ history y-axis✓ method card✓.
