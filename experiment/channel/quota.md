# Upload quota ledger — Earth One (youtube-channel-manager)

Cap model (DECISIONS.md D5): an upload costs ~1,600 units; default daily quota 10,000 →
...
No quota consumed by this project yet. When the first publish wave begins, stage it as
~4–5/day over 4–5 days (D5), alternating near-twin pairs, and file a quota-increase request
in parallel if the cohort should ship faster than the ceiling allows.
